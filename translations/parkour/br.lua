translations.br = {
	...
	help_changelog = "<font size='13'><p align='center'><o>Versão 2.7.0 - 26/10/2020</o></p>\n\n<font size='11'>• <vp>Os checkpoints foram melhoradose</vp>: agora você consegue pegá-los <o>instantaneamente ao passar por eles</o>!\n• Adicionada uma nova tecla para as <cep>salas de recordes</cep>. Aperte <cep>N</cep> para <cep>refazer o mapa</cep>!",
	...
	forum_topic = "<rose>Para mais informações sobre o módulo visite este link: %s",
