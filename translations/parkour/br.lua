translations.br = {
	...
	discord = "<J> Entre em nosso servidor do Discord para ler anúncios e atualizações importantes: <pt>%s</pt>",
	type_help = "<O>Recomendamos que você digite <d>!help</d> para informações úteis!",
