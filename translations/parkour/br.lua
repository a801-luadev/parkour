translations.br = {
	...
	mapping_loaded = "<j>[INFO] <d>Sistema de mapas <t>(v%s)</t> carregado.",
	mapper_joined = "<j>[INFO] <d><ce>%s</ce> <n2>(%s)</n2> entrou na sala.",
	mapper_left = "<j>[INFO] <d><ce>%s</ce> <n2>(%s)</n2> saiu da sala.",
	mapper_loaded = "<j>[INFO] <d><ce>%s</ce> carregou este mapa.",
	...
	perm_changed = "<j>[INFO] <d>Categoria do mapa <ch>@%s</ch> alterada com sucesso, de <r>P%s</r> para <t>P%s</t>.",
