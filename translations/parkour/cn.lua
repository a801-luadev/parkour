translations.cn = {
	...
	bad_outfit = "<r>你穿著的裝扮中有不能在 parkour 使用的飾物/皮毛。",
	insufficient_coins = "<v>[#] <r>你沒有足夠的金幣。",
	insufficient_event_coins = "<r>呃, 有東西掉了。你要檢查一下背包嗎?",
	...
	-- Report Window
	report_window = "<p align='center'><font size='20'><R><b>Parkour 玩家舉報</b></R></font></p>\n請選擇一名玩家和舉報的原因。\n如果你想要提供像是影片證明這樣更詳細的資料, 你可以像這樣使用 <b>!report</b> 指令:\n<i><b>!report 玩家名稱#8787</b> trolling 玩家名稱#4646 youtu.be/dQw4w9WgXcQ</i>",
	report_troll = "惡作劇",
	report_troll_desc = "濫用 parkour 能力/物品來妨礙別人到達下一個重生點 (或是完成地圖)。",
	report_force = "強制協助",
	report_force_desc = "帶有目的且重複的 <r>在違反他人意願下</r> 使用 parkour 能力/物品來嘗試協助別人到達下一個重生點 (或是完成地圖)。\n<CH>如果有人頭上有紅線, 就代表他們不想要被協助。</CH>",
	report_hack = "外掛",
	report_hack_desc = "使用外部工具/程式得到不公平的優勢。\n<rose>而且, 你應該要使用 /report 指令向 Transformice 職員舉報。</rose>",
	report_bug = "濫用漏洞",
	report_bug_desc = "使用漏洞得到不公平的優勢。",
	report_send = "<r><b>送出舉報</b>",
	report_reason = "<r><b>原因:</b> <n>",
	report_room = "<r><b>房間:</b> <n>",
	...
	unlocked_skin = "<ce><d>%s</d> 解鎖了 <vp>%s</vp> 能力的新外觀。",

	-- Information messages
	mod_apps = "<j>Parkour 管理員申請現正開放! 請查看這連結: <rose>%s",
	mapper_apps = "<j>Parkour 地圖管理員申請現正開放! 加入我們的 discord 伺服器查看詳情: <rose>%s",
	...
	shop_loaded = "<j>商店物品已載入。",
	kill_minutes = "<R>你的能力已經被禁止在 %s 分鐘內再次使用。",
	...
	report_responded = "<v>Parkour 管理員正在處理你的舉報。",
	report_chat = "<r>聊天室有關的問題 (刷屏, 侮辱等等) 是由 Transformice 職員處理。 請另外使用 /report 指令。",
	report_tfm = "<r>你的舉報是我們負責範圍以外的。請直接使用 /report 使 Transformice 職員能夠處理。",
	report_invalid = "<r>無效的舉報原因。",
	nohelp = "<r>你現在已經展示了紅線, 這是向其他人表示不想要被協助。可以再按 <v>F</v> 鍵取消。",
	quest_map = "<ch>這正是你要完成的任務地圖 @%s !",
	powers_disabled = "<r>能力不能在這個房間裡使用。",
	powers_enabled = "<vp>可以再次使用能力了。",
	review_enabled = "<v>[#] <d>檢查模式開啟了。",
	review_disabled = "<v>[#] <d>檢查模式關閉了。",
	verify_sent = "<v>[#] <j>Discord 認證已發出。",
	claim_done = "<v>[#] <j>你成功領取了兌換代碼的獎勵。",
	npc_sell_power = "<v>這個自定義能力特價發售中!",
	npc_sell_badge = "<v>給我帶來這種貨幣就可以得到這個徽章!",
	npc_sell_skin = "<v>你想要這個外觀嗎? 給我帶來這種貨幣吧。",
	npc_sell_skin_sale = "<v>這個外觀特價發售中!",
	golem_around = "<CH>有人使用了哥林石人的力量, 你可以按 <V>空格<CH> 鍵得到幫助!",
	...
	found_gift1 = "<ch>好耶! <J>%s</J> 打開了禮物而且在裡面找到了 <J>%s</J> 枚金幣!",
	...
	-- Halloween
	halloween_msg_1 = "<CE>兩個世界之間的帷幕正在顫抖著... <B>神秘的物質</B> 出現了!",
	halloween_msg_2 = "<J>一陣寒冷刺骨的低語在空氣中傳播開來... 在 <B>黑暗材料</B> 消失前收集他們。",
	halloween_msg_3 = "<CE>混沌的影子 — 在發亮的痕跡會展示隱藏在暗夜中的秘密。",
	halloween_msg_4 = "<J>飢餓的藥鍋! 在混亂開始前找到 <B>被遺忘的試劑</B>。",
	halloween_msg_5 = "<CE>血月愈來愈紅... <B>迷人的殘骸</B> 正在大地甦醒過來。",
	halloween_collect_hint = "<ROSE>收集物品然後到 <b><u>/room #parkour0cauldron</u></b> 熬煮出藥水!",
	halloween_cauldron_hint = "<ROSE>你可以到 <b><u>/room #parkour0village</u></b> 使用藥水交換成獨特的獎勵!",
	halloween_npc_1 = "小心看路.. 我的水晶會盯著你",
	halloween_npc_2 = "甜蜜還是致命? 猜錯你就知道了。",
	halloween_npc_3 = "噓... 當我說話的時候就連鬼也安靜下來。",
	halloween_npc_4 = "已經被我的網抓住了? 我就知道。",
	halloween_npc_5 = "你看起來還沒死。不用擔心... 命不久矣了。",
	halloween_npc_6 = "蝙蝠已經告訴我你的名了。我叫他們忘了。",
	halloween_npc_7 = "徽章會隨時間暗淡, 但後悔不會。",
	halloween_npc_8 = "<O>不要動! 我正在感受你的靈氣。嗯... 真嗆喉嚨真失策。",
	halloween_npc_9 = "<O>我曾經施法過一次。屏幕閃爍了好幾個小時。可怕的力量。",
	halloween_npc_10 = "<O>我昨天變隱形了。所有人都忽略了我... 證明那有用。",
	halloween_npc_11 = "<O>你想要看真正的魔術嗎? 閉起眼睛... 看那邊。很恐怖, 不是嗎?",
	halloween_npc_12 = "<O>我不用睡覺。夢會自己跑來找我的意見。",
	halloween_npc_13 = "<O>我的藥鍋曾經試過離開我。我詛咒他留下。這是我最快樂的婚姻。",
	halloween_npc_14 = "<O>安靜! 我正在集中我的能量… 主要是讓他變得更使人難忘。",
	halloween_npc_15 = "<O>這些靈覺得我力量很強。那些鄰居覺得我很麻煩。",
	halloween_npc_16 = "<O>我可以把你變成蟾蜍… 但我已經向最後一隻說過我會就此作罷。",
	halloween_bone = "<N>骨頭</N>",
	halloween_spider_silk = "<N>蜘蛛絲</N>",
	halloween_bat_wing = "<PT>蝙蝠翅膀</PT>",
	halloween_ghost_dust = "<PT>鬼魅塵埃</PT>",
	halloween_pumpkin_seed = "<FC>南瓜種子</FC>",
	halloween_crystal_shard = "<FC>水晶碎片</FC>",
	halloween_potion = "藥水",
	halloween_found_material = "<BL>你找到了</BL> %s!",
	halloween_cauldron_ritual_begin = "<VP>儀式開始了... 向藥鍋獻上你的誠意吧。",
	halloween_cauldron_ritual_end = "<VP>儀式結束了。藥鍋回歸沉靜了。",
	halloween_cauldron_no_offerings = "<R>藥鍋發出嘶嘶聲 — 沒有創造出任何東西。",
	halloween_cauldron_fizzles = "<R>混合物失敗了。藥鍋拒絕了你放進去的物品。",
	halloween_cauldron_complete = "<VP>儀式完成了! <B>%s</B> 隻小鼠同心合力, 藥鍋現在溢出了 <B>%s</B> 個迷人的藥水!",
	halloween_cauldron_reward = "<BV>藥鍋獎勵了你 <B>%s</B> 個藥水, 基於你對儀式投放的 <B>%s%%</B> 誠意!",
	halloween_cauldron_top_contributor = "<ROSE>#%s - <B>%s</B> 全身貢獻給儀式, 投入了 <B>%s%%</B> 誠意而得到了 <B>%s</B> 個閃閃發亮的藥水!",
	halloween_deposits_disabled = "<R>儀式快要完結了 — 現在不再接受貢獻!",
	halloween_all_deposits_cleared = "<VP>已撤回全部貢獻物!",
	halloween_all_materials_selected = "<VP>儀式中所有可用的物品已經準備好!",
	halloween_deposits_disabled_ui = "不接受",
	halloween_no_deposits_to_clear = "<R>你沒有可撤回的物品!",
	halloween_no_materials_available = "<R>你沒有任何可以在儀式中使用的物品!",
	halloween_add_all = "全部加入",
	halloween_remove_all = "全部移除",
	halloween_ritual = "儀式",
	halloween_distribution = "分佈",
	halloween_cauldron_need_players = "<R>開始儀式需要最少 4 人!",
	halloween_cauldron_cancelled = "<R>因為人數不足儀式已經被取消了!",
	halloween_insufficient_materials = "<R>你沒有足夠的物品製作藥水。",
	halloween_potion_limit_reached = "<R>你已經達到了藥水上限! 你不能再加更多的物品到藥鍋裡了。",
	halloween_materials_limited = "<ROSE>你的物品已經被調整成給出 <B>%s</B> 個藥水。多出的物品會保留在你的物品欄裡。 ",
	...
	unlock_power = "<font size='13' face='Lucida Console,Liberation Mono,Courier New'><p align='center'>完成 <v>%s</v> 張地圖<font size='5'>\n\n</font>來解鎖<font size='5'>\n\n</font><v>%s</v>",
	upgrade_power = "<font size='13' face='Lucida Console,Liberation Mono,Courier New'><p align='center'>完成 <v>%s</v> 張地圖<font size='5'>\n\n</font>來升級到<font size='5'>\n\n</font><v>%s</v>",
	unlock_power_rank = "<font size='13' face='Lucida Console,Liberation Mono,Courier New'><p align='center'>階級 <v>%s</v><font size='5'>\n\n</font>來解鎖<font size='5'>\n\n</font><v>%s</v>",
	upgrade_power_rank = "<font size='13' face='Lucida Console,Liberation Mono,Courier New'><p align='center'>階級 <v>%s</v><font size='5'>\n\n</font>來升級到<font size='5'>\n\n</font><v>%s</v>",
	...
	help_badge_24 = "這玩家在 檸檬氣泡水慶典 中取得了這個徽章。",
	help_badge_25 = "這玩家在 萬聖節活動 中取得了這個徽章。",
	make_public = "設定為公開",
	make_private = "設定為私人",
	moderators = "管理員",
	mappers = "地圖管理員",
	...
	sell = "賣出",
	refund = "退款",
	refund_info = "<p align='right'><font size='10'><b><g>退回已花費金幣的 70%。",
	equip = "裝備",
	equipped = "已裝備",
