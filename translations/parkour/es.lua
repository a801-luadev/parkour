translations.es = {
	...
	discord = "<j>Únete a nuestro servidor de discord para recibir todas las actualizaciones y anuncios: <pt>%s</pt>",
	type_help = "<o>¡Te recomendamos que escribas <d>!help</d> para ver información util!",
