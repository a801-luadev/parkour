translations.es = {
	...
	-- Report Window
	report_window = "\"<p align='center'><font size='20'><R><b>Reporte de jugador de parkour</b></R></font></p>\nPor favor, selecciona un jugador y la razón de tu reporte. Si quieres otorgar más detalles (evidencia de video, etc) puedes usar el siguiente comando: <b>!report</b> \n<i><b>!report Username#5903</b> trolling Username#1146 youtu.be/dQw4w9WgXcQ</i>\"",
	report_troll = "Troll",
	...
	report_bug_desc = "Usar glitches, errores o bugs del juego para obtener ventajas injustas.",
	...
	unlocked_skin = "<ce><d>%s</d> desbloqueó una skin para el poder <vp>%s</vp>.",
	...
	report_responded = "<v>Moderadores de parkour están revisando tu reporte.",
	report_chat = "<r>Problemas relacionados con el chat (spam, insultos etc.) son revisados por el staff de Transformice. Por favor, usa /report",
	report_tfm = "<r>Tu reporte está fuera de alcance. Por favor, usa /report así el staff de Transformice puede tomar acciones.",
	report_invalid = "<r>Razón de reporte inválida.",
	...
	review_enabled = "<v>[#] <d>El modo review está habilitado.",
	review_disabled = "<v>[#] <d>El modo review está deshabilitado.",
	verify_sent = "<v>[#] <j>Solicitud de verificación de discord enviada.",
	claim_done = "<v>[#] <j>Has reclamado un código de recompensa de manera exitosa.",
	npc_sell_power = "<v>Este poder de la tienda está a la venta!",
	npc_sell_badge = "<v>Consígueme suficientes monedas de este tipo y obtén la insignia.",
	npc_sell_skin = "<v>Quieres este objeto? Dame este tipo de monedas.",
	npc_sell_skin_sale = "<v>Este objeto está a la venta!",
	golem_around = "<CH>Alguien está usando golem power, puedes mantener <V>ESPACIO<CH>tecla para obtener ayuda!",
	...
	-- Christmas
	find_gift1 = "<ch>Santa acaba de pasar! Busca el regalo de navidad en el mapa y descubre una sorpresa!",
	find_gift2 = "<ch>Jingle all the way! Un regalo navideño especial ha aparecido magicamente en el mapa - ve a buscarlo!",
	find_gift3 = "<ch>Ho, ho, ho! El pequeño ayudante de Santa te ha dejado un regalo que lo encuentres en el mapa actual!",
	find_gift4 = "<ch>El espíritu navideño está en el aire! Encuentra el regalo navideño escondido en este mapa!",
	find_gift5 = "<ch>Merry Parkourmas! Los duendes te han escondido un regalo. ¿Puedes encontrarlo?",
	found_gift1 = "<ch>Hurra! <J>%s</J> has desenvuelto el regalo y encontrado <J>%s</J> monedas dentro!",
	found_gift2 = "<ch>Enhorabuena, <J>%s</J>! Acabas de ganar <J>%s</J> monedas relucientes de parte del regalo mágico de Santa!",
	found_gift3 = "<ch>Es una victoria para<J>%s</J>! <J>%s</J> monedas más rico gracias a Santa!",
	found_gift4 = "<ch>Felicidades a <J>%s</J> por ganar <J>%s</J> monedas! El espíritu navideño brilla con intensidad!",
	found_gift5 = "<ch>El regalo de Santa ha dotado a  <J>%s</J> con<J>%s</J> monedas deslumbrantes!",

	-- Halloween
	halloween_msg_1 = "<CE>El velo entre los mundos tiembla... <B>Los materiales arcanos</B> han emergido!",
	...
	halloween_msg_3 = "<CE>Las sombras se agitan - rastros brillantes revelan lo que la noche ha ocultado.",
	halloween_msg_4 = "<J>El caldero tiene hambre! Busca los <B>reactivos prohibidos</B> antes de que el ritual comience.",
	...
	halloween_npc_1 = "Cuidado dónde miras.. mis cristales te devolverán la mirada.",
	...
	halloween_npc_9 = "<O>Una vez lancé un hechizo. La pantalla parpadeó durante horas. Un poder aterrador.",
	...
	halloween_npc_13 = "<O>Mi caldero intentó abandonarme una vez. Lo maldije para que se quedara. El matrimonio más feliz que he tenido.",
	...
	halloween_cauldron_top_contributor = "<ROSE>#%s - <B>%s</B> lo dieron todo en el ritual, contribuyendo con <B>%s%%</B> y ganando <B>%s</B> pociones brillantes!",
	...
	halloween_cauldron_need_players = "<R>El ritual requiere al menos 2 participantes para comenzar!",
