translations.es = {
	...
	mapping_loaded = "<j>[INFO] <d>Sistema de mapas <t>(v%s)</t> cargado.",
	mapper_joined = "<j>[INFO] <d><ce>%s</ce> <n2>(%s)</n2> entró a la sala.",
	mapper_left = "<j>[INFO] <d><ce>%s</ce> <n2>(%s)</n2> salió de la sala.",
	mapper_loaded = "<j>[INFO] <d><ce>%s</ce> cargó este mapa.",
	...
	perm_changed = "<j>[INFO] <d>Se cambió la categoría del mapa <ch>@%s</ch> desde <r>P%s</r> hacia <t>P%s</t> exitosamente.",
