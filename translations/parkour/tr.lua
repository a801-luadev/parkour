translations.tr = {
	...
	report_responded = "<v>Parkour moderatörleri raporunuzu inceliyor.",
	report_chat = "<r>Sohbetle ilgili sorunlar (spam, hakaret vb.) sadece Transformice moderatörleri tarafından çözülebilir. Lütfen bunun yerine /report komutunu kullanın.",
	report_tfm = "<r>Raporunuz bizim kapsamımızın dışındadır. Lütfen Transformice moderatörlerinin ilgilenebilmesi için /report komutunu kullanarak raporlayın.",
	report_invalid = "<r>Geçersiz rapor sebebi.",
	...
	halloween_msg_2 = "<J>Bir ses duydun mu? Karanlıktan <B>fısıltılar</B> geliyor... Hızlıca malzemeleri topla!",
	halloween_msg_3 = "<CE>Gölgeler kıpırdanıyor! Parlayan izleri takip et, gece ne bıraktıysa senindir.",
	halloween_msg_4 = "<J>Kazan fokur fokur! <B>Gizemli malzemeleri</B> bul ve ritüeli başlat!",
	halloween_msg_5 = "<CE>Ay ışığı tuhaf parlıyor... <B>Büyülü kalıntılar</B> etrafa saçıldı!",
	halloween_collect_hint = "<ROSE>Malzemeleri topla ve <b><u>/room #parkour0cauldron</u></b> odasına giderek iksir yap!",
	halloween_cauldron_hint = "<ROSE>Şimdi <b><u>/room #parkour0village</u></b> odasına giderek iksirlerini özel ödüllerle takas edebilirsin!",
	halloween_ready = "Hazır",
	halloween_cancel = "İptal",
	halloween_npc_1 = "Çok bakma, kristaller kıskanır sonra.",
	halloween_npc_2 = "Tatlı mı zehirli mi? Denemeden bilemezsin.",
	halloween_npc_3 = "Şşşt... Sessiz ol. Ben konuşunca hayaletler bile susar.",
	halloween_npc_4 = "Ağımda mısın? Ah, klasik.",
	halloween_npc_5 = "Hâlâ yaşıyor musun? İlginç.",
	halloween_npc_6 = "Yarasalar adını söyledi, ben de onlara unutmalarını söyledim.",
	halloween_npc_7 = "Rozetler solar... ama pişmanlık kalır.",
	halloween_npc_8 = "<O>Kımıldama! Auranı okuyorum. Hmm… Yanık tost ve kötü kararlar.",
	halloween_npc_9 = "<O>Bir kez büyü yaptım. Ekran saatlerce titredi. Korkunç bir güçtü.",
	halloween_npc_10 = "<O>Dün görünmez oldum. Herkes beni görmezden geldi… Demek ki işe yaradı.",
	halloween_npc_11 = "<O>Gerçek bir büyü görmek ister misin? Gözlerini kapa… İşte. Korkunç, değil mi?",
	halloween_npc_12 = "<O>Uykuya ihtiyacım yok. Rüyalar benden tavsiye almaya gelir.",
	halloween_npc_13 = "<O>Bir kere kazanım beni terk etmeye kalktı. Gitmemesi için lanetledim. En mutlu evliliğimdi.",
	halloween_npc_14 = "<O>Sessizlik! Enerjimi odaklıyorum… Çoğunlukla etkileyici görünmeye.",
	halloween_npc_15 = "<O>Ruhlar bana güçlü der. Komşular sorunlu diyor.",
	halloween_npc_16 = "<O>Seni bir kurbağaya çevirebilirim… Ama sonuncusuna bir daha yapmayacağıma söz verdim.",
	halloween_bone = "<N>Kemik</N>",
	halloween_spider_silk = "<N>Örümcek Ağı</N>",
	halloween_bat_wing = "<PT>Yarasa Kanadı</PT>",
	halloween_ghost_dust = "<PT>Hayalet Tozu</PT>",
	halloween_pumpkin_seed = "<FC>Balkabağı Tohumu</FC>",
	halloween_crystal_shard = "<FC>Kristal Parçası</FC>",
	halloween_potion = "İksir",
	halloween_found_material = "%s <BL>buldun!</BL>",
	halloween_cauldron_ritual_begin = "<VP>Ritüel başlıyor! Topladığın malzemeleri kazana at!",
	halloween_cauldron_ritual_end = "<VP>Ritüel tamamlandı. Kazan sessizliğe büründü.",
	halloween_cauldron_no_offerings = "<R>Kazan tıslıyor... Hiç malzeme atılmadı.",
	halloween_cauldron_fizzles = "<R>Karışım tutmadı. Bu malzemeler işe yaramıyor gibi.",
	halloween_cauldron_complete = "<VP>Ritüel tamamlandı! <B>%s</B> fare güçlerini birleştirdi, kazan <B>%s</B> büyülü iksirle taşıyor!",
	halloween_cauldron_reward = "<BV>Kazan sana <B>%s</B> iksir veriyor! Ritüele olan <B>%%%s</B> katkın için teşekkür ediyor.",
	halloween_cauldron_top_contributor = "<ROSE>#%s - <B>%s</B> tüm gücünü ritüele adadı, <B>%%%s</B> katkıyla <B>%s</B> parıldayan iksir kazandı!",
	halloween_deposits_disabled = "<R>Süre bitiyor! Artık kazana malzeme atamazsın.",
	halloween_all_deposits_cleared = "<VP>Tüm malzemelerin geri alındı!",
	halloween_all_materials_selected = "<VP>Tüm malzemelerin kazana hazır!",
	halloween_deposits_disabled_ui = "Kilitli",
	halloween_no_deposits_to_clear = "<R>Geri alacak bir şeyin yok.",
	halloween_no_materials_available = "<R>Sunabileceğin hiçbir malzeme kalmadı!",
	halloween_add_all = "EKLE",
	halloween_remove_all = "KALDIR",
	halloween_ritual = "Ritüel",
	halloween_distribution = "Dağıtım",
	halloween_cauldron_need_players = "<R>Ritüeli başlatmak için en az 2 katılımcı gerekiyor!",
	...
	lemonade_badge = "Hey, hava gerçekten çok sıcak. Bana 40 adet limonata getirirsen, bu Rozet senin olabilir!",
