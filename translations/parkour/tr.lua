translations.tr = {
	...
	discord = "<j>Önemli duyurular ve güncellemelerden haberdar olmak için discord sunucumuza katılın: <pt>%s</pt>",
	type_help = "<o>İşinize yarayacak bilgileri bulmak için <d>!help</d> yazabilirsiniz!",
