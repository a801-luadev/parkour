translations.en = {
	...
	shop_loaded = "<j>Shop items have been loaded.",
	...
	halloween_msg_2 = "<J>A cold whisper spreads through the air... gather the <B>dark ingredients</B> before they fade.",
	halloween_msg_3 = "<CE>Shadows stir — glowing traces reveal what the night has hidden.",
	halloween_msg_4 = "<J>The cauldron hungers! Seek the <B>forbidden reagents</B> before the ritual begins.",
	halloween_msg_5 = "<CE>The moon bleeds light... <B>enchanted remnants</B> awaken across the land.",
	halloween_collect_hint = "<ROSE>Collect materials and go to <b><u>/room #parkour0cauldron</u></b> to brew potions!",
	halloween_cauldron_hint = "<ROSE>You can go to <b><u>/room #parkour0village</u></b> to trade your potions for exclusive rewards!",
	halloween_ready = "Ready",
	halloween_cancel = "Cancel",
	halloween_npc_1 = "Careful where you stare.. my crystals stare back.",
	halloween_npc_2 = "Sweet or deadly? Guess wrong, and find out.",
	halloween_npc_3 = "Shh… even the ghosts hush when I speak.",
	halloween_npc_4 = "Caught in my web already? How predictable.",
	halloween_npc_5 = "You look alive. Don’t worry… it won’t last.",
	halloween_npc_6 = "The bats told me your name. I told them to forget it.",
	halloween_npc_7 = "Badges fade, but regret doesn’t.",
	halloween_npc_8 = "<O>Don’t move! I’m reading your aura. Hmm… Burnt toast and bad decisions.",
	halloween_npc_9 = "<O>I cast a spell once. The screen flickered for hours. Terrifying power.",
	halloween_npc_10 = "<O>I turned invisible yesterday. Everyone ignored me… Proof that it worked.",
	halloween_npc_11 = "<O>Do you want to see real magic? Close your eyes... There. Terrifying, isn’t it?",
	halloween_npc_12 = "<O>I don’t need sleep. Dreams come to me for advice.",
	halloween_npc_13 = "<O>My cauldron tried to leave me once. I cursed it to stay. Happiest marriage I’ve had.",
	halloween_npc_14 = "<O>Silence! I’m focusing my energy… Mostly on looking impressive.",
	halloween_npc_15 = "<O>The spirits call me powerful. The neighbors call me problematic.",
	halloween_npc_16 = "<O>I could turn you into a toad… but I already promised the last one I’d stop.",
	halloween_bone = "<N>Bone</N>",
	halloween_spider_silk = "<N>Spider Silk</N>",
	halloween_bat_wing = "<PT>Bat Wing</PT>",
	halloween_ghost_dust = "<PT>Ghost Dust</PT>",
	halloween_pumpkin_seed = "<FC>Pumpkin Seed</FC>",
	halloween_crystal_shard = "<FC>Crystal Shard</FC>",
	halloween_potion = "Potion",
	halloween_found_material = "<BL>You’ve found</BL> %s!",
	halloween_cauldron_ritual_begin = "<VP>The ritual begins... Feed the cauldron with your offerings.",
	halloween_cauldron_ritual_end = "<VP>The ritual is over. The cauldron falls silent.",
	halloween_cauldron_no_offerings = "<R>The cauldron hisses — no offerings were made.",
	halloween_cauldron_fizzles = "<R>The mixture fails. The cauldron rejects your materials.",
	halloween_cauldron_complete = "<VP>The ritual is complete! <B>%s</B> mice joined forces, and the cauldron now overflows with <B>%s</B> enchanted potions!",
	halloween_cauldron_reward = "<BV>The cauldron rewards you with <B>%s</B> potions for your <B>%s%%</B> devotion to the ritual!",
	halloween_cauldron_top_contributor = "<ROSE>#%s - <B>%s</B> gave their all to the ritual, contributing <B>%s%%</B> and earning <B>%s</B> shimmering potions!",
	halloween_deposits_disabled = "<R>The ritual nears its end — offerings are now sealed!",
	halloween_all_deposits_cleared = "<VP>All offerings withdrawn!",
	halloween_all_materials_selected = "<VP>All available materials prepared for the ritual!",
	halloween_deposits_disabled_ui = "Sealed",
	halloween_no_deposits_to_clear = "<R>You have no offerings to withdraw!",
	halloween_no_materials_available = "<R>You carry no materials worthy of the ritual!",
	halloween_add_all = "ADD ALL",
	halloween_remove_all = "REMOVE ALL",
	halloween_ritual = "Ritual",
	halloween_distribution = "Distribution",
	halloween_cauldron_need_players = "<R>The ritual requires at least 2 participants to begin!",
	...
	unknown = "Unknown",
	hidden_player = "Anonymous Player",
	powers = "Powers",
	press = "<vp>Press %s",
	click = "<vp>Left click",
	ranking_pos = "Rank #%s",
