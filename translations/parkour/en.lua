translations.en = {
	...
	mapping_loaded = "<j>[INFO] <d>Mapping system <t>(v%s)</t> loaded.",
	mapper_joined = "<j>[INFO] <d><ce>%s</ce> <n2>(%s)</n2> has joined the room.",
	mapper_left = "<j>[INFO] <d><ce>%s</ce> <n2>(%s)</n2> has left the room.",
	mapper_loaded = "<j>[INFO] <d><ce>%s</ce> has loaded a map.",
	...
	perm_changed = "<j>[INFO] <d>Successfully changed the perm of map <ch>@%s</ch> from <r>P%s</r> to <t>P%s</t>.",
