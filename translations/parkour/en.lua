translations.en = {
	...
	discord = "<j>Join our discord server for important announcements and updates: <pt>%s</pt>",
	type_help = "<O>We recommend you to type <d>!help</d> to see useful information!",
