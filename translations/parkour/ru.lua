translations.ru = {
	...
	room_name_length = "<ROSE><b>[ОШИБКА]</b> Название комнаты превышает допустимые <b>45</b> символов. Пожалуйста, выберите название покороче.",
  ...
  cmd_usage_report = "<j>Применение: <bl>!report [Игрок#1234] [причина]",
	...
	report_done = "<j>Спасибо за обращение.",
	nohelp = "<r>Теперь Вы сообщаете другим, что не хотите помощи, активируя красную линию. Нажмите <v>F</v> чтобы переключить.",
  ...
  anniversary = "<bv>Все способности и удвоение монет доступны на следующей неделе (по времени Франции), посвященной дню рождения Паркур!",
	...
	found_gift1 = "<ch>Ура! <J>%s</J> развернули подарок и нашли <J>%s</J> монеты внутри!",
	...
	new_image = "<J>Ваш внешний вид был изменен. Вы можете вернуть его в нормальное состояние, введя !image",
	smol_best = "<j>Новый лидер комнаты режима Смол: %s с %s пройденными картами!",
