translations.ru = {
	...
	discord = "<j>Присоединись к нашему дискорд серверу для важных объявлений и обновлений: <pt>%s</pt>",
	type_help = "<o>Вы можете написать в чате <d>!help</d> чтобы увидеть полезную информацию!",
