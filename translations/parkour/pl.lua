translations.pl = {
	...
	help_changelog = "<font size='13'><p align='center'><o>Wersja 2.1.0 - 27/04/2020</o></p>\n\n• Poprawiony interfejs pomocy\n\t\t• Dodany <o>Aktualności</o> przyciski\n\t\t• Zrobiony <t>szerszy</t>\n\t\t• Dodany <t>przewinania klawisz strzałki</t>\n• Ulepszony <t>sankcje</t> systemu.\n\t\t• Dodany <t>anticheat system</t>.\n• System przeglądania map został zmieniony.\n\t\t• Dodany <t>wysoki</t> oraz <t>niski</t> priorytetowe obroty mapy.\n• Oraz <o>!staff</o> polecenie wyświetla tylko członków online.\n• Wewnętrzne zmiany i poprawki błędów, dzięki czemu gra zawiesza się rzadziej.\n\t\t• Błąd dotyczący <t>ludzie nie są w stanie ukończyć mapy</t> został naprawiony",
