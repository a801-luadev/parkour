translations.pl = {
	...
	corrupt_map_no_perm = "<r>[ERROR] <n>Ta mapa nie jest odpowiednio chroniona.",
	corrupt_map_hole = "<r>[ERROR] <n>Mapy Parkour nie mogą zawierać mysiej norki.",
	...
	room_name_length = "<ROSE><b>[ERROR]</b> Nazwa pokoju musi zawierać odpowiednią liczbe <b>45</b> znaków. Proszę zmienić nazwę.",
	bad_outfit = "<r>Twój strój zawiera przedmiot/futerko które nie może być używane na #parkour.",
	...
	-- Report Window
	report_window = "<p align='center'><font size='20'><R><b>Parkour zgłaszanie graczy</b></R></font></p>\nProszę wybrać gracza oraz powód zgłoszenia. Jeśli chcesz dodać więcej szczegółów jak nagranie możesz użyć<b>!report</b> następująca komenda:\n<i><b>!report Nazwagracza#5903</b> trolling Username#1146 youtu.be/dQw4w9WgXcQ</i>",
	report_troll = "Przeszkadzanie",
	report_troll_desc = "Utrudnianie komuś przejścia do kolejnego punktu kontrolnego lub ukończenia mapy poprzez nadużywanie mocy.",
	report_force = "Wymuszona Pomoc.",
	report_force_desc = "Umyślne i nadgorliwe próby pomocy komuś przejścia na kolejny punkt kontrolny czy zakończenia mapy <r>Wbrew woli tej osoby</r> poprzez używanie mocy.\n<CH>Jeśli ktoś ma czerwona linie nad nazwą oznacza to że ta osoba nie chce pomocy.</CH>",
	report_hack = "Hack",
	report_hack_desc = "Używanie narzędzi zewnętrznych/programów żeby uzyskać niesprawiedliwą przewagę.\n<rose>Powinieneś również zgłosić ich do zespołu transformice /report </rose>",
	report_bug = "Nadużywanie błędów",
	report_bug_desc = "Używanie błedów glitchy żeby uzyskać niesprawiedliwą przewagę",
	report_send = "<r><b>Wyślij zgłoszenie</b>",
	report_reason = "<r><b>Powód:</b> <n>",
	report_room = "<r><b>Pokój:</b> <n>",
	...
	unlocked_skin = "<ce><d>%s</d> odblokowałeś skórkę do <vp>%s</vp> mocy.",

	-- Information messages
	mod_apps = "<j>Rekrutacja na  moderatora Parkour jest już otwarta! Użyj tego linku: <rose>%s",
	mapper_apps = "<j>Aplikacja na mappera Parkour została otwarta! Dołącz do naszego discorda po więcej informacji: <rose>%s",
	...
	shop_loaded = "<j> Sklep przedmiotów został załadowany",
	...
	report = "<j>Chcesz zgłosić gracza parkour? <t><b>!report Nazwagracza#0000 [powód]</b></t>",
	...
	cmd_usage_report = "<j>Użyj: <bl>!report [Gracz1234] [powód]",
	reported_not_here = "<bl>Zgłoszony gracz musi być w tym pokoju.",
	reported_invalid = "<bl>Ten gracz nie może być zgłoszony.",
	reason_too_short = "<bl>Powód zgłoszenia jest zbyt długi.",
	report_done = "<j>Dziękujemy za zgłoszenie.",
	report_responded = "<v>Moderatorzy Parkour zajmują się twoim zgłoszeniem.",
	report_chat = "<r>Rzeczami związanymi z czatem typu spam, obrażanie etc zajmują się moderatorzy gry użyj /report aby ich zgłosić",
	report_tfm = "<r>Twoje zgłoszenie nie jest związane z regulaminem modułu użyj /report żeby moderacja transformice mogła się tym zająć",
	report_invalid = "<r> niepoprawny powód zgłoszenia",
	nohelp = "<r>Teraz mówisz innym że nie chcesz pomocy poprzez włączenie czerwonej linii. Kliknij <v>F</v> Aby ją wyłączyć.",
	quest_map = "<ch>Twoja mapa do ukończenia zadania @%s jest tutaj!",
	powers_disabled = "<r>Moce są wyłączone w tym pokoju.",
	powers_enabled = "<vp>Moce są dostępne ponownie.",
	review_enabled = "<v>[#]<d>Przegląd jest włączony",
	review_disabled = "<v>[#]<d>Przegląd jest wyłączony",
	verify_sent = "<v>[#]<j>Wniosek weryfikacji na discordzie został wysłany.",
	claim_done = "<v>[#]<j>Odebrałeś nagrodę z kodu prawidłowo.",
	...
	anniversary = "<bv>Podwójne monety parkour w następnym tygodniu (Czasu Francuskiego) oraz wszystko moce są odblokowane na czas urodzin parkour!",
	anniversary_start = "<rose>Trwa Urodzinowy tydzień parkour! Podwójne monety oraz wszystkie moce zostały odblokowane. Dziękujemy za całe wsparcie oraz granie w ten moduł!",
	anniversary_end = "<rose>Urodzinowy tydzień parkour zakończył się. Dziękujemy za wsparcie oraz granie w ten moduł!",
	...
	found_gift1 = "<ch>Brawo! <J>%s</J>otworzył prezent i znalazł w nim <J>%s</J> monet!",
	...
	unlock_power = "<font size='13' face='Lucida Console,Liberation Mono,Courier New'><p align='center'>Ukończyć <v>%s</v> mapę<font size='5'>\n\n</font>odblokować<font size='5'>\n\n</font><v>%s</v>",
	upgrade_power = "<font size='13' face='Lucida Console,Liberation Mono,Courier New'><p align='center'>Ukończyć<v>%s</v> mapę<font size='5'>\n\n</font>uaktualnić do<font size='5'>\n\n</font><v>%s</v>",
	unlock_power_rank = "<font size='13' face='Lucida Console,Liberation Mono,Courier New'><p align='center'>Ranga<v>%s</v><font size='5'>\n\n</font>odblokować<font size='5'>\n\n</font><v>%s</v>",
	upgrade_power_rank = "<font size='13' face='Lucida Console,Liberation Mono,Courier New'><p align='center'>Ranga <v>%s</v><font size='5'>\n\n</font>uaktualnić do<font size='5'>\n\n</font><v>%s</v>",
	...
	help_badge_16 = "Ten gracz uzyskał najszybszy czas na 5 mapach.",
	help_badge_17 = "Ten gracz uzyskał najszybszy czas na 10 mapach.",
	help_badge_18 = "Ten gracz uzyskał najszybszy czas na 15 mapach.",
	help_badge_19 = "Ten gracz uzyskał najszybszy czas na 20 mapach.",
	help_badge_20 = "Ten gracz uzyskał najszybszy czas na 25 mapach.",
	help_badge_21 = "Ten gracz uzyskał najszybszy czas na 30 mapach.",
	help_badge_22 = "Ten gracz uzyskał najszybszy czas na 35 mapach.",
	help_badge_23 = "Ten gracz uzyskał najszybszy czas na 40 mapach.",
	help_badge_24 = "Ten gracz kupił te odznakę na wydarzeniu festynu lemoniady ",
	make_public = " pokaż",
	make_private = "ukryj",
	...
	sell = "Sprzedaż",
	refund = "Zwrot",
	refund_info = "<p align='right'><font size='10'><b><g>Zwrot 70% wydanych monet na przedmiot.",
	equip = "Wyposaż",
	equipped = "<font size = '10'>Wyposażono</font>",
	saving = "<p align='right'> Zapisywanie...",
	new_image = "<J>Twój wygląd został zmieniony. Możesz to cofnąć używając !image",
	smol_best = "<j>Nowy lider trybu smol: %s z %s Ukończonymi mapami!",
	event = "Wydarzenie",
	settings = "Ustawienia",
