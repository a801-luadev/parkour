translations.id = {
    ...
    min_players = "<r>Untuk menyimpan data anda, setidaknya ada 4 pemain di ruangan ini. <bl>[%s/%s]",
    ...
    help_private_maps = "Pemain ini tidak mau memperlihatkan jumlah peta mereka ke publik! jika ingin, anda juga bisa menyembunyikannya di profil anda.",
    ...
    close = "Tutup",
    cant_load_bot_profile = "<v>[#] <r>Anda tidak bisa melihat profil bot ketika #parkour menggunakannya secara internal untuk bekerja lebih baik.",
